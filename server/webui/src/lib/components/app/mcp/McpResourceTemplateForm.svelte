<script lang="ts">
	...
	import InputWithSuggestions from '$lib/components/app/forms/InputWithSuggestions.svelte';
...
<form onsubmit={handleSubmit} class="space-y-3">
	...
	{#if isComplete}
		<div class="rounded-md bg-muted/50 px-3 py-2">
			<p class="text-xs text-muted-foreground">{t('mcp.resolvedUri')}</p>
	...
	<div class="flex justify-end gap-2 pt-1">
		...
		<Button size="sm" type="submit" disabled={!isComplete}>{t('mcp.readResource')}</Button>
	</div>
</form>
